...
namespace Monorail.Audio
{
    ...
    struct float3
    {
        ...
        public float3(float fx, float fy, float fz)
        {
            f1 = fx;
            f2 = fy;
            f3 = fz;
    ...
    struct EFX_REVERB_PROPERTIES
    {
        ...
        public float3 flReflectionsPan;
        public float flLateReverbGain;
        public float flLateReverbDelay;
        public float3 flLateReverbPan;
        ...
        public EFX_REVERB_PROPERTIES(float density,
                                 float diffusion,
                                 float gain,
                                 float gainHF,
                                 float gainLF,
                                 ...
                                 float3 reflectionsPan,
                                 float lateReverbGain,
                                 float lateReverbDelay,
                                 float3 lateReverbPan,
                                 float echoTime,
                                 float echoDepth,
                                 ...
                                 int decayHFLimit)
       {
            ...
            flEchoDepth = modulationTime;
            flModulationTime = modulationDepth;
            flModulationDepth = airAbsorptionGainHF;
    ...
    static class AudioEffectPreset
    {
        public static EFX_REVERB_PROPERTIES GENERIC
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(1.0000f, 1.0000f, 0.3162f, 0.8913f, 1.0000f, 1.4900f, 0.8300f, 1.0000f, 0.0500f, 0.0070f, new float3(0.0000f, 0.0000f, 0.0000f), 1.2589f, 0.0110f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_PADDEDCELL
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(0.1715f, 1.0000f, 0.3162f, 0.0010f, 1.0000f, 0.1700f, 0.1000f, 1.0000f, 0.2500f, 0.0010f, new float3(0.0000f, 0.0000f, 0.0000f), 1.2691f, 0.0020f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_ROOM
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(0.4287f, 1.0000f, 0.3162f, 0.5929f, 1.0000f, 0.4000f, 0.8300f, 1.0000f, 0.1503f, 0.0020f, new float3( 0.0000f, 0.0000f, 0.0000f), 1.0629f, 0.0030f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_BATHROOM
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(0.1715f, 1.0000f, 0.3162f, 0.2512f, 1.0000f, 1.4900f, 0.5400f, 1.0000f, 0.6531f, 0.0070f, new float3(0.0000f, 0.0000f, 0.0000f), 3.2734f, 0.0110f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_LIVINGROOM
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(0.9766f, 1.0000f, 0.3162f, 0.0010f, 1.0000f, 0.5000f, 0.1000f, 1.0000f, 0.2051f, 0.0030f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2805f, 0.0040f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_STONEROOM
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(1.0000f, 1.0000f, 0.3162f, 0.7079f, 1.0000f, 2.3100f, 0.6400f, 1.0000f, 0.4411f, 0.0120f, new float3(0.0000f, 0.0000f, 0.0000f), 1.1003f, 0.0170f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_AUDITORIUM
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(1.0000f, 1.0000f, 0.3162f, 0.5781f, 1.0000f, 4.3200f, 0.5900f, 1.0000f, 0.4032f, 0.0200f, new float3(0.0000f, 0.0000f, 0.0000f), 0.7170f, 0.0300f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_CONCERTHALL
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(1.0000f, 1.0000f, 0.3162f, 0.5623f, 1.0000f, 3.9200f, 0.7000f, 1.0000f, 0.2427f, 0.0200f, new float3(0.0000f, 0.0000f, 0.0000f), 0.9977f, 0.0290f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_CAVE
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(1.0000f, 1.0000f, 0.3162f, 1.0000f, 1.0000f, 2.9100f, 1.3000f, 1.0000f, 0.5000f, 0.0150f, new float3(0.0000f, 0.0000f, 0.0000f), 0.7063f, 0.0220f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x0);
            }
        }

        public static EFX_REVERB_PROPERTIES EFX_REVERB_PRESET_ARENA
        {
            get
            {
                return new EFX_REVERB_PROPERTIES(1.0000f, 1.0000f, 0.3162f, 0.4477f, 1.0000f, 7.2400f, 0.3300f, 1.0000f, 0.2612f, 0.0200f, new float3(0.0000f, 0.0000f, 0.0000f), 1.0186f, 0.0300f, new float3(0.0000f, 0.0000f, 0.0000f), 0.2500f, 0.0000f, 0.2500f, 0.0000f, 0.9943f, 5000.0000f, 250.0000f, 0.0000f, 0x1);
            }
        }
        ...
        public static EFX_REVERB_PROPERTIES SewerPipe
        {
            get
            {
                var rv = new EFX_REVERB_PROPERTIES();
                rv.flDensity = 0.3071f;
                rv.flDiffusion = 0.8000f;
                rv.flGain = 0.3162f;
                rv.flGainHF = 0.3162f;
                rv.flGainLF = 1.0000f;
                rv.flDecayTime = 2.8100f;
                rv.flDecayHFRatio = 0.1400f;
                rv.flDecayLFRatio = 1.0000f;
                rv.flReflectionsGain = 1.6387f;
                rv.flReflectionsDelay = 0.0140f;
                rv.flReflectionsPan.f1 = 0;
                rv.flReflectionsPan.f2 = 0;
                rv.flReflectionsPan.f3 = 0;
                rv.flLateReverbGain = 3.2471f;
                rv.flLateReverbDelay = 0.0210f;
                rv.flLateReverbPan.f1 = 0;
                rv.flLateReverbPan.f2 = 0;
                rv.flLateReverbPan.f3 = 0;
                rv.flEchoTime = 0.2500f;
                rv.flEchoDepth = 0.0000f;
                rv.flModulationTime = 0.2500f;
                rv.flModulationDepth = 0;
                rv.flAirAbsorptionGainHF = 0.9943f;
                rv.flHFReference = 5000.0000f;
                rv.flLFReference = 250.0000f;
                rv.flRoomRolloffFactor = 0;
                rv.iDecayHFLimit = 0x1;
                return rv;
            }
        }
    }
