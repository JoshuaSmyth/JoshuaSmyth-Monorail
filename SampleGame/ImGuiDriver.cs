...
namespace SampleGame
{
    ...
    public struct VertexImGui : IInterleavedVertex
    {
        ...
        public static int[] AttributeOffsets { get { return new[] { 0, 8, 16 }; } }
    }
    ...
    public class ImGuiDriver
    {
        ...
        public virtual unsafe void BuildFontAtlas()
        {
            ...
            m_Texture = m_ResourceManager.CreateTexture2d(width, height, bytesPerPixel);
        ...
        private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
        {
            ...
            var indexCount = drawData.TotalIdxCount * VertexImGui.Stride;
            var vertCount = drawData.TotalVtxCount * sizeof(ushort);
            ...
            for (int n = 0; n < drawData.CmdListsCount; n++)
            {
                ...
                fixed (void* vtxDstPtr = &m_Verts[vertOffset * VertexImGui.Stride])
                fixed (void* idxDstPtr = &m_Indicies16[indexOffset * sizeof(ushort)])
                {
                    Buffer.MemoryCopy((void*)cmdList.VtxBuffer.Data, vtxDstPtr, vertCount, vertCount);
                    Buffer.MemoryCopy((void*)cmdList.IdxBuffer.Data, idxDstPtr, indexCount, indexCount);
                }
            ...
            m_VertexArrayObject.UpdateVertexData<VertexImGui>(m_Verts, 0, vertOffset);
        ...
        public void Draw()
        {
            if (true)
            {
                //       ImGui.Begin("This is a test window", ref _showWindow, ImGuiWindowFlags.NoCollapse);
